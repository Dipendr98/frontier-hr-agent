...
| **Final** | Seven bounded agents across three modes, direction-aware evidence gate, claim verification on a real LLM agent, cohort memory, independent rubric, strengthened baseline | quality **63.3% → 93.0%** vs strongest baseline, **0** unverifiable claims, unsupervised LLM claim error **30% → 0%**, 78 tests pass offline | Main contribution: It. 4 + It. 7, corrected by It. 13, honestly measured by It. 9–11 and It. 16. |
